    ...
    >
      ...
      {image && (
        <Fragment>
          ...
          <button
            type="button"
            className="absolute z-10 flex items-center justify-center invisible w-16 h-16 text-red-500 transition-all bg-white rounded-full opacity-0 cursor-pointer flex-center group-hover:opacity-100 group-hover:visible"
